...
export const ACTORS = Object.freeze([
  {
    ...
    initialAnchorId: "roadside.player-start",
    sourceLevel: "S2",
    stagingLevel: "S2",
  ...
  },
  {
    ...
    initialAnchorId: "roadside.jesus",
    sourceLevel: "S1",
    stagingLevel: "S2",
  ...
  },
  {
    ...
    initialAnchorId: "roadside.disciples",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
  },
  {
    ...
    label: "那人",
    kind: "scripture-character",
    initialAnchorId: "roadside.blind-man-seat",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
  },
  {
    ...
    label: "鄰舍與見過他的人",
    kind: "scripture-group",
    initialAnchorId: "neighbors.group-left",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
  },
  {
    ...
    label: "法利賽人",
    kind: "scripture-group",
    initialAnchorId: "inquiry.pharisees-left",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
  },
  {
    ...
    label: "他的父母",
    kind: "scripture-group",
    initialAnchorId: "inquiry.waiting",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
  },
  {
    ...
    label: "猶太人",
    kind: "scripture-group",
    initialAnchorId: "inquiry.pharisees-right",
    sourceLevel: "S1",
    stagingLevel: "S2",
    scriptureCharacter: true,
    hasDialogue: true,
...
export const PROPS = Object.freeze([
  {
    id: "clay",
    label: "泥",
    initialAnchorId: "roadside.clay-action",
    sourceLevel: "S1",
    stagingLevel: "S2",
  },
]);
