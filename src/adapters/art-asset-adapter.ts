...
if (
  ...
  throw new Error("Story-local runtime art is not approved for private preview.");
}
...
export const STORY_ART = Object.freeze({
  ...
  props: Object.freeze({
    oliveCanopy: runtimeAsset("olive-canopy.png"),
    palmFrond: runtimeAsset("palm-frond.png"),
