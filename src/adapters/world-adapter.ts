...
export interface StoryActorState {
...
export interface StoryAreaMetadata {
...
export interface WorldRuntime {
  ...
  readonly actors: readonly MapActor<StoryActorState>[];
  readonly areas: readonly MapArea<StoryAreaMetadata>[];
